...
In addition random forest models are less prone to over fitting because they use ensemble learning. For this case in particular I decided on random forest because it can use both discrete and continuous variables.
